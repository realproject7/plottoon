...
describe('getDefaultPublishConfig', () => {
  it('returns config with Base RPC defaults and plotlink-ows retry timing', () => {
    ...
    expect(config.storyFactoryAddress).toBe('0x9D2AE1E99D0A6300bfcCF41A82260374e38744Cf')
    expect(config.mcv2BondAddress).toBe('0xc5a076cad94176c2996B32d8466Be1cE757FAa27')
